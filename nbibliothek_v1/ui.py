...
class BibliothekUI:
    ...
    def grid_borrowed_desc(self, master):
        row = 6
        borrowed_1 = ttk.Label(master, text="", width = 32,anchor="center")
    ...
    def grid_return_button(self, master):
        ...
        return_1 = Button(master, text=self.__key_lang['return_button'], fg="#ff0000", bg="white",
                          command=lambda: self.__return_book_click(book1_label, time1),width=10, anchor="center")
        return_1.grid(row=row + 4, column=3, sticky="se")
        return_2 = Button(master, text=self.__key_lang['return_button'], fg="#ff0000", bg="white",
                          command=lambda: self.__return_book_click(book2_label, time2),width=10, anchor="center")
        return_2.grid(row=row + 5, column=3)
        return_3 = Button(master, text=self.__key_lang['return_button'], fg="#ff0000", bg="white",
                          command=lambda: self.__return_book_click(book3_label, time3),width=10, anchor="center")
    ...
    def __create_member_search_button(self):
        row = 6
        master = self._tabs[0]
        entry_label = Label(master, text=self.__key_lang['member_nim'], borderwidth=1,width=20)
